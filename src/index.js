...
controller.hears(['.*'], ['direct_message', 'direct_mention', 'mention', 'ambient'], (bot, message) => {
    try {
        if (message.type == 'message') {
            ...
            else if (message.text.indexOf("/") == 0 && message.text.indexOf(bot.identity.id) == -1) {
                // skip all the slash commands
            }

            // else if (message.type = 3) {
                
            //     // let image_title = title.text;
            //     // let image_subtitle = subtitle.text;
            //     // let image_url = imageUrl.text;
            // }
                ...
                request.on('response', (response) => {
                    ...
                    // bot.reply(message, responseData.toattach);
